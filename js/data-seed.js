...
export function seedData() {
    if (getData("categorias").length === 0) {
        saveData("categorias", [
            { id: 1, nombre: "Rock", descripcion: "Conciertos de bandas y solistas de rock." },
            { id: 2, nombre: "Pop", descripcion: "Espectáculos de artistas pop nacionales e internacionales." },
            { id: 3, nombre: "Urbano", descripcion: "Reggaetón, trap y música urbana en general." },
            { id: 4, nombre: "Vallenato", descripcion: "Conciertos de música vallenata y popular." }
        ]);
    }
        ...
        saveData("ventas", [
            {
                ...
                ciudad: "Bogotá",
                items: [{ id: 1, nombre: "Rock al Parque", precio: 85000, cantidad: 1, subtotal: 85000 }],
                total: 85000
            },
            {
                id: 2,
                ...
                ciudad: "Barranquilla",
                items: [
                    { id: 2, nombre: "Noche Vallenata", precio: 120000, cantidad: 2, subtotal: 240000 }
                ],
                total: 240000
            }
        ]);
